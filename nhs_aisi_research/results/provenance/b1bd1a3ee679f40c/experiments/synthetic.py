...
POLICIES=['uniform','uncertainty','boundary','bias_blind_kg','ordinary_kg',
          'two_channel_uniform','validation_only','two_channel_kg']
...
def run_policy(data,policy,budget,cost,assumed_beta=.35,assumed_sigma=2.5,seed=1,
    ...
    beta=0 if policy in {'uniform','uncertainty','boundary','bias_blind_kg'} else assumed_beta
