...
def main():
    ...
    frame=frame.loc[frame.year.eq(2025)&frame.is_trust.eq(1)&frame.burnout_score.notna()].sort_values('org_code').reset_index(drop=True)
    ...
    manifest(ROOT/'results/nhs_scenario_manifest.json',dict(source_sha256=sha(source),
