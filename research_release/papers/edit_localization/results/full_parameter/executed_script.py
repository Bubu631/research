...
def main():
    ...
    # These sinusoidal modules execute under @torch.no_grad(). Some loaded
    # library versions mark their serialized parameters requires_grad=True;
    # preserve their actual fixed-position semantics explicitly.
    fixed_positions=[]
    ...
    manifest=dict(completed=False,scope='Full default trainable parameter mean gradients; no optimizer update',
        ...
        explicitly_fixed_sinusoidal_parameters=fixed_positions,
